...
--[[ TODO
 ...
 - Нельзя забанить кого-то с привилегиями модератора / server
 - Чтение привилегий из настроек
 - Замена команд луанти на eban по опции из настроек
 - Локализация надписей
 - Опция "щедящая система", которая не будет банить айпи/имя пользователей при заходе с забанненым именем/айпи
 - Выдача информации по бану для забанненого игрока
 - Ссылка на контакты для связи с администрацией через опции в настройках при планшке ТЫ ЗАБАНЕН
 - Дата бана/разбана?
 - Временные баны?
